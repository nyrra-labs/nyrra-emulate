...
describe("Foundry compute-module contour routes", () => {
  it("requires bearer auth for contour execute", async () => {
    ...
    const res = await app.request(`${base}/contour-backend-multiplexer/api/module-group-multiplexer/compute-modules/jobs/execute`, {
      method: "POST",
  ...
  it("returns queued handles for async jobs and transitions status to succeeded", async () => {
    ...
    const submitRes = await app.request(`${base}/contour-backend-multiplexer/api/module-group-multiplexer/deployed-apps/jobs`, {
      method: "POST",
      headers: {
        ...authHeader(),
        "Content-Type": "application/json",
    ...
    const resultRes = await app.request(`${base}/contour-backend-multiplexer/api/module-group-multiplexer/jobs/result/v2`, {
      method: "PUT",
      headers: {
        ...authHeader(),
        "Content-Type": "application/json",
